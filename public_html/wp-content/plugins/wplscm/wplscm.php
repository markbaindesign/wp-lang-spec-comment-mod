...
function baindesign_wplscm_plugin_init() {
	...
	if ( class_exists( 'SitePress' ) ) {
		...
		function baindesign_wplscm_get_post_language( $post_id ) {
			$post_language_details = apply_filters( 'wpml_post_language_details', null, $post_id ); // phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedHooknameFound -- WPML's own filter, not ours.
